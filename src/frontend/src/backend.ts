...
import { Actor, type ActorConfig, type ActorSubclass, type Agent, HttpAgent, type HttpAgentOptions } from "@icp-sdk/core/agent";
...
import type { BlogRole as _BlogRole, CommentView as _CommentView, ExternalBlob as _ExternalBlob, PostView as _PostView, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string, arg1: string, arg2: string, arg3: Array<ExternalBlob>): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createPost(arg0, arg1, arg2, await to_candid_vec_n12(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async editPost(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editPost(arg0, arg1, arg2, arg3, await to_candid_vec_n12(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async register(arg0: string, arg1: Uint8Array, arg2: Uint8Array): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateUserRole(arg0: string, arg1: BlogRole): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserRole(arg0, to_candid_BlogRole_n33(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BlogRole_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BlogRole): BlogRole {
    return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
async function from_candid_CommentView_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CommentView): Promise<CommentView> {
...
async function from_candid_PostView_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PostView): Promise<PostView> {
...
async function from_candid_opt_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PostView]): Promise<PostView | null> {
    return value.length === 0 ? null : await from_candid_PostView_n26(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        blogRole: from_candid_BlogRole_n16(_uploadFile, _downloadFile, value.blogRole)
    };
}
...
async function from_candid_record_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        mediaUrls: await from_candid_vec_n28(_uploadFile, _downloadFile, value.mediaUrls),
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "moderator" in value ? BlogRole.moderator : "user" in value ? BlogRole.user : "superadmin" in value ? BlogRole.superadmin : value;
}
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CommentView>): Promise<Array<CommentView>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CommentView_n21(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PostView>): Promise<Array<PostView>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PostView_n26(_uploadFile, _downloadFile, x)));
}
...
function to_candid_BlogRole_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BlogRole): _BlogRole {
...
function to_candid_record_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        alias: value.alias,
        isBlocked: value.isBlocked,
        blogRole: to_candid_BlogRole_n33(_uploadFile, _downloadFile, value.blogRole)
    };
}
...
function to_candid_variant_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BlogRole): {
    moderator: null;
} | {
    user: null;
} | {
