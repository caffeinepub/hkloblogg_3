...
export const CategoryPermission = IDL.Record({
  readAllowlist: IDL.Vec(IDL.Text),
  commentAllowlist: IDL.Vec(IDL.Text),
});
...
export const idlService = IDL.Service({
  ...
  getCategories: IDL.Func([], [IDL.Vec(CategoryView)], ["query"]),
  getCategoryPermissions: IDL.Func([IDL.Text], [CategoryPermission], ["query"]),
  getCommentsForPost: IDL.Func([IDL.Text], [IDL.Vec(CommentView)], ["query"]),
  ...
  setCategoryPermissions: IDL.Func(
    [IDL.Text, IDL.Vec(IDL.Text), IDL.Vec(IDL.Text)],
    [],
    [],
  ),
  setCategoryVisibility: IDL.Func([IDL.Text, IDL.Bool], [], []),
...
export const idlFactory = ({ IDL }) => {
  ...
  const CategoryPermission = IDL.Record({
    readAllowlist: IDL.Vec(IDL.Text),
    commentAllowlist: IDL.Vec(IDL.Text),
  });
  const Time = IDL.Int;
  ...
  return IDL.Service({
    ...
    getCallerUserRole: IDL.Func([], [UserRole], ["query"]),
    getCategories: IDL.Func([], [IDL.Vec(CategoryView)], ["query"]),
    getCategoryPermissions: IDL.Func(
      [IDL.Text],
      [CategoryPermission],
      ["query"],
    ),
