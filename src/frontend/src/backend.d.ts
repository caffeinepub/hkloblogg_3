...
export interface backendInterface {
    ...
    createPost(title: string, body: string, categoryId: string, mediaUrls: Array<ExternalBlob>): Promise<string>;
    deleteAccount(): Promise<void>;
    deleteCategory(categoryId: string): Promise<void>;
    deleteComment(commentId: string): Promise<void>;
    deletePost(postId: string): Promise<void>;
    editPost(postId: string, title: string, body: string, categoryId: string, mediaUrls: Array<ExternalBlob>): Promise<void>;
